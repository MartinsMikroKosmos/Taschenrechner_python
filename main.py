...
btn_mul = tk.Button(root, text="*", command=lambda: add_to_calc("*"), width=5, font=("Arial", 14))
btn_mul.grid(row=4, column=4)
btn_dif = tk.Button(root, text="/", command=lambda: add_to_calc("/"), width=5, font=("Arial", 14))
btn_dif.grid(row=5, column=4)
...
btn_gleich = tk.Button(root, text="=", command=evaluate_calc, width=5, font=("Arial", 14))
btn_gleich.grid(row=6, column=3, columnspan=2)
